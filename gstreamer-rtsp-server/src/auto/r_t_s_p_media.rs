...
impl<O: IsA<RTSPMedia> + IsA<glib::object::Object>> RTSPMediaExt for O {
    ...
    fn get_do_retransmission(&self) -> bool {
        unsafe {
            from_glib(ffi::gst_rtsp_media_get_do_retransmission(self.to_glib_none().0))
        }
    }
    ...
    fn set_do_retransmission(&self, do_retransmission: bool) {
        unsafe {
            ffi::gst_rtsp_media_set_do_retransmission(self.to_glib_none().0, do_retransmission.to_glib());
        }
    }
